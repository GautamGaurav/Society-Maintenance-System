...
export function mapSiteUnit(row) {
  ...
  if (mapped.room_layout !== undefined) { mapped.roomLayout = mapped.room_layout; delete mapped.room_layout; }
  if (mapped.area_size !== undefined) { mapped.areaSize = mapped.area_size; delete mapped.area_size; }
  return mapped;
}

export function mapOwner(row) {
  const mapped = mapObjectKeysToCamel(row);
  if (mapped.site_unit !== undefined) { mapped.siteUnit = mapped.site_unit; delete mapped.site_unit; }
  if (mapped.contact_no !== undefined) { mapped.contactNo = mapped.contact_no; delete mapped.contact_no; }
  return mapped;
}

export function mapSociety(row) {
  const mapped = mapObjectKeysToCamel(row);
  if (mapped.registration_no !== undefined) { mapped.registrationNo = mapped.registration_no; delete mapped.registration_no; }
  if (mapped.site_unit !== undefined) { mapped.siteUnit = mapped.site_unit; delete mapped.site_unit; }
  if (mapped.contact_no !== undefined) { mapped.contactNo = mapped.contact_no; delete mapped.contact_no; }
  if (mapped.president_name !== undefined) { mapped.presidentName = mapped.president_name; delete mapped.president_name; }
  return mapped;
}
